  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const endpoints = [
        ...
        {
          url: `${process.env.REACT_APP_SERVER_BASE_URL}/film/list/new`,
          key: "phimmoiCN",
        },
        {
        ...
        {
          url: "https://phimapi.com/v1/api/danh-sach/phim-bo?limit=12",
          key: "phimBo",
        },
        {
          url: "https://phimapi.com/v1/api/danh-sach/hoat-hinh?limit=12",
          key: "phimHH",
        },
        {
          url: "https://phimapi.com/v1/api/danh-sach/tv-shows?limit=12",
          key: "tvShows",
        },
      ];

      try {
        const results = await fetchingApiData(
